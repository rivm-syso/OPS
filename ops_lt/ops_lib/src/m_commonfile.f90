...
!
INTEGER,   PARAMETER                             :: IOB_IU       = 1           ! currently not used
INTEGER,   PARAMETER                             :: IOB_SETUP    = 2           ! currently not used
INTEGER,   PARAMETER                             :: IOB_STDIN    = 5           ! currently not used  
INTEGER,   PARAMETER                             :: IOB_STDOUT   = 6           ! standard output     
INTEGER,   PARAMETER                             :: IOB_STDERR   = 7           ! currently not used  
!
! CONSTANTS - Other fileunits
!
INTEGER,   PARAMETER                             :: fu_input       = 100         ! unit number input (control) file
INTEGER,   PARAMETER                             :: fu_varin       = 110         ! unit number input file for input model parameters (varin)
INTEGER,   PARAMETER                             :: fu_log         = 200         ! unit number log file
INTEGER,   PARAMETER                             :: fu_exit        = 300         ! currently not used
INTEGER,   PARAMETER                             :: fu_progress    = 350         ! unit number progress file
INTEGER,   PARAMETER                             :: fu_scratch     = 400         ! unit number scratch file
INTEGER,   PARAMETER                             :: fu_bron        = 500         ! unit number sources file
INTEGER,   PARAMETER                             :: fu_dist        = 550         ! unit number distributions file (e.g. diurnal variations, particle size distributions)
INTEGER,   PARAMETER                             :: fu_tmp         = 560         ! unit number temporary file
INTEGER,   PARAMETER                             :: fu_recep       = 600         ! unit number receptor file
INTEGER,   PARAMETER                             :: fu_mask        = 600         ! unit number mask file
INTEGER,   PARAMETER                             :: fu_klim        = 700         ! unit number meteo statistics file
INTEGER,   PARAMETER                             :: fu_z0          = 700         ! unit number z0 file
INTEGER,   PARAMETER                             :: fu_plt         = 800         ! unit number plot file
INTEGER,   PARAMETER                             :: fu_classoutput = 801       ! unit number for OPS LT _classoutput.csv file
INTEGER,   PARAMETER                             :: fu_prt         = 900         ! unit number print file
INTEGER,   PARAMETER                             :: fu_err         = 950         ! unit number error file
!
...
CHARACTER*24                                     :: map_gamma                  ! name of file with gamma water values (for each year)
...
! LOCAL VARIABLES
INTEGER                                          :: extpos                     ! position in control file name where extension starts.
