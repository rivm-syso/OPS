...
!-------------------------------------------------------------------------------------------------------------------------------
TYPE TError
   LOGICAL                                       :: haserror = .false.         ! error has occurred
   LOGICAL                                       :: blockparam                 ! 
   CHARACTER*512                                 :: message = ' '                   ! string with error message

   TYPE (TErrorCall), pointer                    :: callroutines               ! call stack
   TYPE (TErrorCall), pointer                    :: lastcall => null()                 ! last called routine
   ...
   LOGICAL                                       :: debug = .false.            ! if true -> debug parameters are written to screen; only useful for a limited number of receptors and sources
END TYPE TError
...
INTERFACE ErrorParam
   MODULE PROCEDURE error_iparam                                               ! integer   parameter
   MODULE PROCEDURE error_iaparam                                              ! integer   parameter array
...
! INPUTS      : errorunit  (integer) Unit of the error file. Error file should be opened before.
...
! INPUTS      : indentpos  (integer) Optional. Number of blanks preceding the copying.
...
!               becomes a ~.
! INPUTS      : blanks     (integer) Optional. Number of blanks preceding the appended string.
!               appended   (type, type is generic). String, float, integer or logical value appended.
!               significance (integer,   only when appended is of real type) Significance in number of digits.
...
! SUBROUTINE ARGUMENTS - INPUT
CHARACTER*(*), INTENT(IN)                        :: paramname                  ! parameter name
INTEGER,   INTENT(IN)                            :: value(:)                   ! parameter values
...
! SUBROUTINE ARGUMENTS - INPUT
INTEGER,   INTENT(IN)                            :: indentpos                  ! indentation position
CHARACTER*(*), INTENT(IN)                        :: sourcestring               ! string to be copied
...
! LOCAL VARIABLES
INTEGER                                          :: position                   ! insertion position in targetstring
INTEGER                                          :: newtargetlength            ! final length of target string
INTEGER                                          :: maxtargetlength            ! maximum length in targetstring
...
! SUBROUTINE ARGUMENTS - INPUT
INTEGER,   INTENT(IN)                            :: intvalue                   ! string to be appended
...
! LOCAL VARIABLES
INTEGER                                          :: targetlength               ! current length of targetstring (LEN_TRIM)
INTEGER                                          :: stringlength               ! maximum length of targetstring (LEN)
INTEGER                                          :: position                   ! position counter in writing to string
INTEGER                                          :: nrdigits                   ! number of digits in intvalue
INTEGER                                          :: intcopy                    ! copy of integer
INTEGER                                          :: intcopy2                   ! copy of integer
INTEGER                                          :: char0                      ! '0' character
...
INTEGER,   INTENT(IN)                            :: significance               ! number of significant digits
...
INTEGER                                          :: targetlength               ! current length of targetstring (LEN_TRIM)
INTEGER                                          :: position                   ! position counter in writing to string
INTEGER                                          :: power                      ! the e-value in the number
INTEGER                                          :: counter                    ! simple loop counter
REAL                                             :: realcopy                   ! copy of realvalue
INTEGER                                          :: intcopy                    ! copy of significant realvalue
INTEGER                                          :: intcopy2                   ! copy of significant realvalue
INTEGER                                          :: char0                      ! '0' character
LOGICAL                                          :: negative                   ! 
...
! FUNCTION RESULT
INTEGER                                          :: appendblanks               ! 

! LOCAL VARIABLES
INTEGER                                          :: position                   ! insertion position in targetstring
INTEGER                                          :: targetlength               ! new length of targetstring
INTEGER                                          :: maxtargetlength            ! maximim length in targetstring
