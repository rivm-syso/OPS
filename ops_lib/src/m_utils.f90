...
INTEGER*4, INTENT(OUT), optional                 :: beyondpos_out              ! First position beyond integer in string; 0 if end of line

! LOCAL PARAMETERS
INTEGER*4                                        :: beyondpos                  ! First position beyond integer in string; 0 if end of line
